...
import {createTextFile, runCode} from "../services/code.ts";

const serverWsUrl = import.meta.env.VITE_SERVER_WS_URL;

export default function CodeRoom() {
    const theme = useTheme();
    const [programResult, setProgramResult] = useState <any[]> ([])
    ...
    const handleRunCode = () => {
        ...
        const data = runCode(createTextFile(value));
        console.log(data)
    ...
    return (
        ...
        <Grid container id="123456789">
            ...
            <Grid item xs={12} md={2} sx={{ padding: '24px' }} id="here">
